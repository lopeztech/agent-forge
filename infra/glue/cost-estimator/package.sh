#!/usr/bin/env bash
# Bundle the cost-estimator Lambda into a single CJS file Terraform's
# archive_file can zip. Mirrors infra/glue/webhook-verifier/package.sh.
#
# Output: infra/glue/cost-estimator/dist/index.js
#
